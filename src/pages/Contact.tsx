export default function Contact(){
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 fade-in-up">
      <h1 className="text-2xl font-bold mb-4 gradient-text">Contact</h1>
      <form className="space-y-4">
        ...
        <button className="bg-primary text-white px-4 py-2 rounded hover:bg-secondary transition-colors">Send</button>
      </form>
